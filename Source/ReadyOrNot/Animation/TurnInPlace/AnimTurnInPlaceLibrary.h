...
public:
	...
	static void UpdateTurnInPlace(float DeltaTime, bool bAllowTurnInPlace, bool bHoldYawOffset, bool bIsTurnTransitionStateRelevant, bool bClampYawOffset, float YawOffsetLimit,
	...
	/* When reaching bounadries with blendspaces a 180 degree flip is likely to happen, this function makes sure that the yaw offset interpolates to the other direction before flipping 
	*/
