...
public:
	 ...
	 */ 
	void Update(float DeltaTime, bool bAllowTurnInPlace, bool bHoldYawOffset, bool bIsTurnTransitionStateRelevant, bool bClampYawOffset, float YawOffsetLimit,
	...
	UAnimSequence* ActiveTurnAnim = nullptr;
...
private:
	 ...
	 */ 
	void UpdateActiveTurnTransition(float DeltaTime, float TurnInPlaceSpeedMultiplier);
	...
	UPROPERTY(transient)
	UAnimSequence* PendingTurnAnim = nullptr;
